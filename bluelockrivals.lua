...
local CharacterTab = Window:CreateTab("localplayer", 0)

local ESPTab = Window:CreateTab("esp", 0)

local TeamTab = Window:CreateTab("team", 0)

local StyleTab = Window:CreateTab("styles", 0)

local FlowTab = Window:CreateTab("flow", 0)

local CosmeticTab = Window:CreateTab("cosmetics", 0)

local UITab = Window:CreateTab("uisettings", 0)
...
StyleTab:CreateDropdown({
    ...
    Callback = function(Options)
        player.PlayerStats.Style.Value = Options[1]
    end
})
...
CosmeticTab:CreateLabel("Cosmetics Soon Next Update")
